...
GsupPlot=subplot(2,2,2);
        ...
        el = 90;
        view(az, el);
        a = get(GsupPlot,'XTickLabel'); 
        set(GsupPlot,'XTickLabel',a,'Fontsize',18)
        title(Title_plot,'FontSize',24)
        title (Title_plot, 'position' , Title_position)   
        colormap(jet);
        set(GsupPlot,'Position',[0.399 0.6 0.3347 0.3412])
        caxis manual
        caxis([0.0 4.0]);
        text(0.8,1.1,4,{'*'},...
